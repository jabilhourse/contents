 ...
 * generated in the cn.itcast.cxf.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.cxf.ws.itcast.cn/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.cxf.ws.itcast.cn/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.cxf.weather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.ws.itcast.cn/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.ws.itcast.cn/", name = "queryWeatherResponse")
