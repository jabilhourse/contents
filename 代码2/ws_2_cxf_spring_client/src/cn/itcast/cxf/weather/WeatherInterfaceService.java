 ...
 * 2015-11-27T10:11:06.790+08:00
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", 
                  wsdlLocation = "http://127.0.0.1:12345/weather?wsdl",
                  targetNamespace = "http://server.cxf.ws.itcast.cn/") 
public class WeatherInterfaceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.cxf.ws.itcast.cn/", "WeatherInterfaceService");
    public final static QName WeatherInterfacePort = new QName("http://server.cxf.ws.itcast.cn/", "WeatherInterfacePort");
    static {
        URL url = null;
        try {
