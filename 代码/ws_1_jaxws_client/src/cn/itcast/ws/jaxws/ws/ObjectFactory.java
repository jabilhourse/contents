 ...
 * generated in the cn.itcast.ws.jaxws.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://ws.jaxws.ws.itcast.cn/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://ws.jaxws.ws.itcast.cn/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.ws.jaxws.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaxws.ws.itcast.cn/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaxws.ws.itcast.cn/", name = "queryWeatherResponse")
